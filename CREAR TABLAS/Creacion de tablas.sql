...
-- 2. --------- Hechos institucional consolidados (particionada por anio) ---------
...
-- 3. --------- dm_certificado (particionada por ano_eje) ---------
...
-- 4. --------- dm_expediente (particionada por ano_eje) ---------
...
-- 5. --------- hechos_pim (NO se particiona; no tiene campo de año directo) ---------
...
CREATE TABLE IF NOT EXISTS hechos_pim (
    ...
    PARTITION BY LIST (id_periodo_pla);
ALTER TABLE hechos_pim OWNER TO postgres;

-- 6. --------- vw_obras_materializada (NO se particiona; no tiene año) ---------
